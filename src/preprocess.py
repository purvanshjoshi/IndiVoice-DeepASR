...
def create_manifest(audio_dir, transcript_dir, output_manifest):
    """
    Creates a JSONL manifest file for Whisper fine-tuning.
    """
    manifest_entries = []
    ...
    for audio_file in tqdm(audio_files):
        ...
        # Assuming transcripts have the same base name as audio files
...
def main():
    ...
    parser.add_argument("--input_dir", type=str, required=True, help="Directory containing raw audio")
    ...
    print(f"Standardizing {len(raw_files)} audio files to {args.target_sr}Hz Mono...")
